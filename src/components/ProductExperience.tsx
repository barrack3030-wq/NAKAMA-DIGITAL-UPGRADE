...
export default function ProductExperience() {
  ...
  return (
    <section className="py-16 lg:py-24 bg-[#0A0A0B] overflow-hidden relative text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6 text-balance leading-tight">
