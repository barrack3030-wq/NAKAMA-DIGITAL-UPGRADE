  ...
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight text-brand-900 mb-8 text-balance">
          ...
          <p className="text-xl text-gray-500 mb-12 max-w-2xl mx-auto font-medium text-balance">
            {t.cta.desc}
          </p>
