  ...
  return (
    <>
      ...
      <a 
        ...
        className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-xl flex items-center justify-center z-50 hover:bg-[#128C7E] transition-colors"
  ...
  return (
    <LanguageProvider>
      <div className="relative min-h-screen bg-[#FDFDFF] overflow-hidden selection:bg-brand-500 selection:text-white">
        {/* Global Apple-inspired White Canvas & Mesh Gradient */}
