            ...
            <div className="flex flex-col">
              {t.features.items.map((feature, index) => (
                <motion.div
                  ...
                  className="py-5 border-b border-gray-100 last:border-0 group"
                >
                  <div className="flex items-center gap-6">
                    <span className="text-lg font-medium text-gray-300 group-hover:text-brand-300 transition-colors">
                      0{index + 1}
                    </span>
                    <h3 className="text-xl md:text-2xl font-semibold text-brand-900 group-hover:text-brand-600 transition-colors">
                      {feature}
                    </h3>
                  </div>
                </motion.div>
